 ...
 * {@link KojiException} to be handled by the client code.
 * 
 * @author Tom
 */
public final class XmlExceptionHandler
{
	 ...
	 */
	public static KojiException handleFault(final XmlRpcException exception)
	{
		...
		return new KojiException(message, exception);
	}
